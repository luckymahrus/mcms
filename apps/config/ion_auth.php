...
*/
$config['tables']['users']           = 'ta_users';
$config['tables']['groups']          = 'ta_groups';
$config['tables']['users_groups']    = 'ta_users_groups';
$config['tables']['login_attempts']  = 'ta_login_attempts';
 ...
 */
$config['site_title']                 = "Music CMS";         // Site Title, example.com
